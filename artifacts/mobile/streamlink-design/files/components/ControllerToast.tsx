...
/**
 * Small, non-blocking toast that surfaces controller connect/disconnect events
 * so the user knows the in-app gamepad navigation is live. Sits above all
 * routes via the root layout.
 */
