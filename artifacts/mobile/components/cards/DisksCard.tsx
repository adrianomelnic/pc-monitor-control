...
const createStyles = (t: Theme) => {
  ...
  return StyleSheet.create({
    ...
    diskBadgeText: { fontSize: 12, fontFamily: "Inter_700Bold", letterSpacing: t.sectionLabelLetterSpacing, fontVariant },
    fstype: { fontSize: 9, color: C.textMuted, fontFamily: "Inter_600SemiBold", letterSpacing: t.sectionLabelLetterSpacing },
    usageRow: { flexDirection: "row", alignItems: "center", gap: 8 },
    usageFlex: { flex: 1 },
    usagePct: { fontSize: 12, fontFamily: "Inter_700Bold", width: 36, textAlign: "right", fontVariant },
    spaceRow: { flexDirection: "row", alignItems: "center", gap: 6 },
    spaceUsed: { fontSize: 10, color: C.text, fontFamily: "Inter_600SemiBold", fontVariant },
    spaceFree: { fontSize: 10, color: C.success, fontFamily: "Inter_600SemiBold", fontVariant },
    spaceTotal: { fontSize: 10, color: C.textMuted, fontFamily: "Inter_500Medium", fontVariant },
    ...
    ioLabel: { fontSize: 9, color: C.textMuted, fontFamily: "Inter_600SemiBold", letterSpacing: t.sectionLabelLetterSpacing },
    ioVal: { fontSize: 13, fontFamily: "Inter_700Bold", fontVariant },
