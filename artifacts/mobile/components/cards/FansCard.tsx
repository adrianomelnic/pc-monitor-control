...
const createStyles = (t: Theme, accent: string) => {
  ...
  return StyleSheet.create({
    ...
    emptyCode: { fontFamily: "Menlo, monospace", color: C.text },
    ...
    diagBtnText: { fontSize: 12, fontFamily: "Inter_700Bold", color: accent, letterSpacing: 0.3 },
    diagBox: {
      backgroundColor: C.backgroundTertiary,
      borderRadius: t.innerRadius,
      padding: 12,
    ...
    diagOk: { fontSize: 12, fontFamily: "Inter_700Bold", color: C.success, marginBottom: 4 },
    diagFail: { fontSize: 12, fontFamily: "Inter_700Bold", color: C.danger, marginBottom: 4 },
    diagSection: { fontSize: 11, fontFamily: "Inter_700Bold", color: C.textSecondary, marginTop: 6 },
