...
const createPickerStyles = (t: Theme) => {
  ...
  return StyleSheet.create({
    ...
    cancel: { fontSize: 14, color: C.tint, fontFamily: "Inter_500Medium", width: 56 },
    heading: { fontSize: 15, fontFamily: "Inter_700Bold", color: C.text },
    searchWrap: {
      flexDirection: "row",
      alignItems: "center",
      gap: 8,
    ...
    groupName: { flex: 1, fontSize: 12, fontFamily: "Inter_700Bold", color: C.text },
    ...
    typeBadgeText: { fontSize: 10, fontFamily: "Inter_700Bold", fontVariant },
...
const createStyles = (t: Theme) => {
  ...
  return StyleSheet.create({
    ...
    bigNum: { fontSize: 34, fontFamily: "Inter_700Bold", letterSpacing: -1, lineHeight: 38, fontVariant },
    bigUnit: { fontSize: 16, fontFamily: "Inter_500Medium" },
    bigLabelText: {
      fontSize: 11,
    ...
    singleNum: { fontSize: 48, fontFamily: "Inter_700Bold", letterSpacing: -2, lineHeight: 52, fontVariant },
    singleUnit: { fontSize: 22, fontFamily: "Inter_500Medium" },
    pureRows: { gap: 6 },
    editActions: {
      flexDirection: "row",
      gap: 8,
    ...
    editActionText: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: C.textMuted },
    empty: {
      fontSize: 13,
      color: C.textMuted,
      textAlign: "center",
    ...
    tileValue: { fontSize: 20, fontFamily: "Inter_700Bold", textAlign: "center", lineHeight: 24, fontVariant },
    tileUnit: {
      fontSize: 9,
      fontFamily: "Inter_600SemiBold",
      letterSpacing: t.sectionLabelLetterSpacing,
...
const createDragStyles = (t: Theme) => {
  ...
  return StyleSheet.create({
    ...
    editPanelRowText: { fontSize: 12, color: C.text, fontFamily: "Inter_500Medium", flex: 1 },
    editPanelLabelInput: {
